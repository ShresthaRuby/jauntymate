                ...
                <div class="row">
                    <div class="col-xs-12 " id="response">
                        ...
                        function get_tp($id) {
                            ...
                            $data1 = mysqli_fetch_array($res) or die(mysql_error());
                            return $data1;
                            //print_r($data1);
                        }
                        ...
                        if ($conn != NULL) {
                            ...
                            $sql = "SELECT name_list,g.id,description FROM tbl_group as g inner join tbl_trip as t where g.id=t.group_id";
                            $result = mysqli_query($conn, $sql);
                            while ($sql = mysqli_fetch_array($result)) {
                                $value = explode(",", $sql['name_list']);
                                if (in_array($_SESSION['session_user_id'], $value)) {
                                    continue;
                                } else {
                                    ?>
                                    <div class="panel panel-default">
                                        <div class="panel panel-heading"><a style="color:black" href="group.php?id=<?php echo $sql['id']; ?>"><?php echo get_group_name($sql['id']); ?></a></div>
                                        <div class="panel panel-body"><?php echo $sql['description']; ?></div>
                                    </div>
                                    <?php
                                }
                            }
...
//                                $array = explode(",", $arr);
//                                // print_r($array);
//                                if (in_array($_SESSION['session_user_id'], $array)) {
//                                    continue;
//                                } else {
//                                    
//                                    $data1 = get_tp($r['id']);
